...
export const Home = () => {
  return (
    ...
    >
      <div className=" h-full flex flex-col items-center justify-center border-2 border-red-400">
        <div className="font-extrabold text-2xl sm:text-3xl text-[#c40c1c] pb-4">Welcome to Property Hunt</div>
        <div className="text-center text-4xl sm:text-6xl font-extrabold text-red-500">
          Your Gateway to Exceptional Properties <br /> Discover <span className="text-[#c40c1c]"> <TypeEffect/> </span> 
        </div>
        <div className="sm:w-[20%] flex space-x-2 justify-center mb-2 mt-6 sm:mt-10">
